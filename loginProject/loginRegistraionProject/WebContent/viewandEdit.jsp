...
<%-- 	<div><label>Password    :</label><%=(emp.getPass() != null) ? emp.getPass() : ""%></div><br>--%>
 	<div><label>Contact    :</label><%=(emp.getContact() != 0) ? emp.getContact() : ""%></div><br>
	<div><label>User_Id    :</label><%=(emp.getUserid() != 0) ? emp.getUserid() : ""%></div><br>
...
<tr>
<td><label>Password    :</label></td><td><input type="password" id="pwd" value="<%=(emp.getPass() != null) ? emp.getPass() : ""%>"> <br></td>
</tr>
<tr>
<td><label>Contact    :</label></td><td><input type="number" id="contact" value="<%=(emp.getContact() != 0) ? emp.getContact() : ""%>"> <br></td>
</tr>
<tr>
<td><label>User_Id    :</label></td><td><input type="text" id="uid" readonly="readonly" value="<%=(emp.getUserid() != 0) ? emp.getUserid() : ""%>"> <br><br></td>
</tr>
</table>
